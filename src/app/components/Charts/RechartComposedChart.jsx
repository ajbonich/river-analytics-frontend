		...
		return (
			<ResponsiveContainer height={260}>
				<ComposedChart data={this.props.data} syncId={'dailyData'}>
					...
					{this.props.xAxis}
					{this.props.yAxis}
					<Area type="monotone" dataKey="middleFifty" stroke="#349dcf" fill="#349dcf" fillOpacity={0.5}/>
					<Line
							type="monotone"
							dataKey="average"
							stroke="#000000"
                    ...
                    <Tooltip label=""
                        formatter={(value, name, props) => {
							if (name === 'middleFifty') {
								return [`Middle 50%: ${props.payload.middleFifty[0]} - ${props.payload.middleFifty[1]} cfs`, '']
							} else {
