...
const MatxCustomizer = (props) => {
    ...
    const { settings, classes, setLayoutSettings, setDefaultSettings } = props
    ...
    const updateSettings = (newSettings) => {
        const updatedSettings = merge({}, settings, newSettings)
    ...
    const handleChange = (name, value) => {
        ...
        const updatedSettings = set(settings, name, value)
